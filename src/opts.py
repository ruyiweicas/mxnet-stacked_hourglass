...
class opts():
    ...
    def init(self):
        ...
        self.parser.add_argument('-embedding_dims', type = int, default = 128, help = 'embedding dims of discriminator')
        self.parser.add_argument('-epochs', type = int, default = 30, help = 'epochs for training GAN')
